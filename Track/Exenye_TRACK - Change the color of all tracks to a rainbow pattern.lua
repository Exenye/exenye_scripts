--[[
    @description Rainbow Track Colors
    @author Exenye
    @version 1.1
    @about
        Colors all tracks in the current project with a smooth rainbow gradient.
        Creates visually appealing track organization with automatic color distribution.
