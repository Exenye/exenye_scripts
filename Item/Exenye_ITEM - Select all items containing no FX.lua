--[[
    Script: Exenye_ITEM - Select all items containing no FX
    Author: Exenye
    Description: Select all media items that contain no FX (Item-FX or Take-FX)
    Version: 1.0
...
local function select_items_with_fx()
  ...
  for i = 0, count-1 do
    ...
    if not item_contains_fx(it) then
